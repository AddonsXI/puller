...
Thanks to atom0s. The check result packet layout and its message ids come from his [Checker](https://github.com/AshitaXI/Ashita-v4beta/tree/main/addons/checker) addon.
